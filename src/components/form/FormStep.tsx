...
export function FormStep({ eyebrow, title, description, children }: FormStepProps) {
  return (
    <section className="step-enter rounded-[1.5rem] border border-white/70 bg-white/90 p-5 shadow-[0_28px_80px_rgba(15,23,42,0.12)] backdrop-blur sm:p-7 dark:border-slate-700/80 dark:bg-slate-950/90 dark:shadow-[0_30px_90px_rgba(0,0,0,0.42)]">
